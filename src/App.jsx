  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4 19a2 2 0 0 0 2 2h12V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v14Z"
      />
  ...
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4 13v4a2 2 0 0 0 2 2h2v-6H6a2 2 0 0 0-2 2Zm16 0v4a2 2 0 0 1-2 2h-2v-6h2a2 2 0 0 1 2 2Z"
      />
    </svg>
  );
}
...
function FeatureCard({ icon, title, desc, iconColor }) {
  return (
    <div className="rounded-[24px] bg-[#f2f6f9] p-4 transition duration-300 hover:-translate-y-1 hover:shadow-[0_8px_20px_rgba(15,23,42,0.05)]">
...
function ApiPage({ onBack, onMenu, onToast }) {
  ...
  return (
    <div className="mx-auto max-w-sm px-3 pb-8 animate-[fadeIn_.3s_ease]">
      <div className="mt-4 rounded-[28px] border border-cyan-100 bg-white p-4 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">
        <div className="flex items-center justify-between">
          <button
            onClick={onMenu}
            className="flex h-14 w-14 items-center justify-center rounded-full bg-sky-500 text-white shadow-[0_10px_24px_rgba(14,165,233,0.30)] transition duration-300 hover:scale-[1.03] active:scale-[0.95]"
          >
            <IconMenu />
          </button>
      ...
      <div className="mt-7 flex justify-center">
        <img
          ...
          alt="Muinzz API"
          className="h-[160px] w-[78%] rounded-[26px] object-cover shadow-[0_10px_24px_rgba(15,23,42,0.06)] transition duration-300 hover:scale-[1.01]"
        />
      </div>

      <div className="mt-7 text-center">
        <h2 className="text-[30px] font-extrabold text-sky-500">Muinzz API</h2>
        <p className="mt-2 text-[13px] text-slate-400">API solutions for developer.</p>
      </div>

      <div className="mt-6 grid grid-cols-3 gap-3">
        <div className="rounded-[24px] border border-cyan-100 bg-white px-3 py-4 text-center shadow-[0_8px_20px_rgba(15,23,42,0.03)] transition duration-300 hover:-translate-y-1">
          <p className="text-[10px] font-bold uppercase text-slate-400">Clock</p>
          <p className="mt-2 text-[16px] font-extrabold text-sky-500">{clock}</p>
        </div>
      ...
      <div className="mt-5 flex justify-center">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full bg-sky-500 px-6 py-3 text-[13px] font-extrabold text-white shadow-[0_12px_24px_rgba(14,165,233,0.30)] transition duration-300 hover:scale-[1.02] active:scale-[0.98]"
        >
          <IconLayers />
      ...
      <section className="mt-10 rounded-[30px] border border-cyan-100 bg-white p-4 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">
        <div className="mb-4 flex items-center gap-2 text-slate-500">
          <IconLocation />
          <h3 className="text-[12px] font-extrabold uppercase tracking-[0.18em]">Weather Info</h3>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[12px] text-slate-400">Muinzz API Music</div>
            </div>
          </div>

          <div className="flex items-center gap-3">
            <button
              onClick={() => onToast("Fitur play music belum aktif.", "info")}
              className="flex h-14 w-14 items-center justify-center rounded-full bg-sky-500 text-white shadow-[0_12px_24px_rgba(14,165,233,0.25)] transition duration-300 hover:scale-[1.03] active:scale-[0.95]"
            >
              <IconPlay />
            </button>
            <button
              onClick={() => onToast("Fitur next music belum aktif.", "info")}
              className="flex h-14 w-14 items-center justify-center rounded-full bg-violet-400 text-white shadow-[0_12px_24px_rgba(167,139,250,0.25)] transition duration-300 hover:scale-[1.03] active:scale-[0.95]"
            >
              <IconNext />
            </button>
          </div>
  ...
  return (
    ...
    >
      ...
      {currentPage === "api" ? (
        ...
        <div className="mx-auto max-w-sm px-3 pb-6 animate-[fadeIn_.3s_ease]">
          ...
          <div className="relative h-full w-[82%] max-w-[340px] animate-[slideInLeft_.22s_ease] rounded-r-[28px] bg-white p-5 shadow-2xl">
            ...
            <div className="mt-7 rounded-[20px] border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 text-[11px] leading-5 text-slate-500">
                Fitur lama tetap ada, dan laman API bisa dibuka dari sidebar tanpa ngebunuh tampilan lama.
              </p>
            </div>
          </div>
        </div>
